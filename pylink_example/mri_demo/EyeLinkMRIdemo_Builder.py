...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/bridge-center/bridge/pylink-example/pylink_example/mri_demo/EyeLinkMRIdemo_Builder.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    while continueRoutine:
        ...
        if ready.status == STARTED and not waitOnFlip:
            theseKeys = ready.getKeys(keyList=None, ignoreKeys=None, waitRelease=False)
    ...
    for thisBlock in block:
        ...
        while continueRoutine:
            ...
            if keyTrigger.status == STARTED and not waitOnFlip:
                theseKeys = keyTrigger.getKeys(keyList=['t'], ignoreKeys=None, waitRelease=False)
        ...
        if keyTrigger.keys != None:  # we had a response
            ...
            block.addData('keyTrigger.duration', keyTrigger.duration)
            ...
            while continueRoutine and routineTimer.getTime() < 5.0:
                ...
                if image.tStartRefresh is not None and sentImageMessage == 0:
                    ...
                    el_tracker.sendMessage('!V IMGLOAD CENTER ../../%s %i %i' % \
                        (trialImage,scn_width/2,scn_height/2)) 
                ...
                if resp.status == STARTED and not waitOnFlip:
                    theseKeys = resp.getKeys(keyList=["z","m"], ignoreKeys=None, waitRelease=False)
